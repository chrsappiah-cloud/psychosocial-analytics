...
- Role-based access (clinician / administrator) and subscription tiers
...
See [CONFIGURATION.md](CONFIGURATION.md) for Supabase, Cloudflare, iCloud, and IAP product IDs.
