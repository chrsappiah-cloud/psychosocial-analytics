...
public enum AccessibilityID {
    ...
    public static let buttonDeleteAccount = "button_delete_account"
    public static let tabAdmin = "tab_admin"
    public static let screenAdminPanel = "screen_admin_panel"
    public static let screenLogin = "screen_login"
    public static let fieldLoginEmail = "field_login_email"
    public static let fieldLoginDisplayName = "field_login_display_name"
    public static let fieldLoginPassword = "field_login_password"
    public static let buttonSignIn = "button_sign_in"
